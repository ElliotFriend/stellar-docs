...
The maximum number of operations per ledger, as determined by validator vote. As of July 2026, 1,000 operations for the mainnet and 200 operations for the testnet; check current values on Stellar Lab's [Network Limits](https://lab.stellar.org/network-limits) page.
